...
namespace TallyJ3.Models
{
    ...
    public abstract class ElectionAnalyzerCore : DataConnectedModel
    {
        ...
        //{
        //  get { return _deleteResult ?? SharedDbContext.Result.Remove; }
        //}

        ///// <Summary>Remove this result from the datastore</Summary>
        //protected Func<ResultTie, ResultTie> RemoveResultTie
        //{
        //  get { return _deleteResultTie ?? ResultTieSaver(DbAction.AttachAndRemove,  SharedDbContext.ResultTie.Remove; }
        //}
        /// <Summary>Remove this result from the datastore</Summary>
        /// <Summary>Save all datastore changes</Summary>
        //protected Func<int> SaveChanges
        //{
        //  get { return _saveChanges ?? SharedDbContext.SaveChanges; }
        //}
        ...
        //      return 0;
        //    }
        //    return SharedDbContext.BulkInsert(; }
        //}
        ...
        public List<Person> People
        {
            get
            {
                return _people ?? (_people = new PersonCacher(SharedDbContext).AllForThisElection);
            }
        }
        ...
        public List<ResultTie> ResultTies
        {
            get
            {
                ...
                return _resultTies = new ResultTieCacher(SharedDbContext).AllForThisElection;
            }
        }
        ...
        /// <Summary>Votes are loaded, in case SharedDbContext updates are required.</Summary>
        public List<Vote> Votes
        {
            get { return _votes ?? (_votes = new VoteCacher(SharedDbContext).AllForThisElection); }
        }
        ...
        {
            get { return _ballots ?? (_ballots = new BallotCacher(SharedDbContext).AllForThisElection); }
        }

        /// <Summary>Current Results records</Summary>
        public List<Result> Results
        {
            get { return _results ?? (_results = new ResultCacher(SharedDbContext).AllForThisElection); }
        }

        public List<ResultSummary> ResultSummaries
        {
            get { return _resultSummaries ?? (_resultSummaries = new ResultSummaryCacher(SharedDbContext).AllForThisElection); }
        }
        ...
        /// <Summary>Check locally and in SharedDbContext to see if the result is available at the moment</Summary>
        public bool IsResultAvailable
        {
            get
            {
                if (ResultSummaryFinal != null && ResultSummaryFinal.Id > 0)
                {
                    return true;
                }

...
namespace TallyJ3.Code.Helper
{
    ...
    {
        public object RequestContext { get; internal set; }

        internal object[] Action(string v1, string v2)
        {
    ...
    public class MenuHelper
    {
        ...
        public HtmlString InsertMenu(string menuId = "main")
        {
            ...
            return result.JoinedAsString("", true).AsRawHtml();
        }

...
namespace TallyJ3Tests.FrameworkTests
{
    ...
    public class ExtensionTests
    {
        ...
        {
            "ab".Right(5).ShouldEqual("ab");
            "ab".Right(2).ShouldEqual("ab");
            "ab".Right(1).ShouldEqual("b");
            "ab".Right(0).ShouldEqual("");

            "".Right(1).ShouldEqual("");
            "".Right(0).ShouldEqual("");

            string n = null;
            n.Right(10).ShouldEqual("");
            n.Right(0).ShouldEqual("");

            "abcdef".Right(3).ShouldEqual("def");
       }
